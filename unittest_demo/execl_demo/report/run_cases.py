...
sys.path.append(cur_path)                           # 加入环境变量
from execl_demo.common import HTMLTestRunner, get_token

token = get_token.get_token()                       # 登录token
...
if __name__ == "__main__":
    ...
    port = 465
    receiver = ['xxx@qq.com']  # 可多个接收的邮箱 传list对象
